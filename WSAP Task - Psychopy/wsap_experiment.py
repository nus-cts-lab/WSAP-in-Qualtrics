...
Converted from jsPsych/Qualtrics implementation
"""
...
class WSAPExperiment:
    def __init__(self):
        ...
        self.instruction_height = 0.03   # Reduced from 0.04 to make instructions smaller
...
Press F or J to proceed."""
        ...
        instruction_stim = visual.TextStim(
            ...
            color='white',
            wrapWidth=1.4,  # Further reduced from 1.6 to 1.4 for more margin space
    ...
    def show_sentence(self, sentence):
        ...
        sentence_stim = visual.TextStim(
            ...
            wrapWidth=1.4,   # Further reduced from 1.6 to 1.4 for more margin space
            bold=True,
            pos=(0, 0),      # Perfectly centered on screen
            alignText='center'  # Ensure center alignment
        )
    ...
    def show_words_and_get_response(self, words, labels, is_practice=False):
        ...
        # Create text stimuli with center alignment
        left_stim = visual.TextStim(
            win=self.win,
            text=left_word,
            height=self.text_height,
            color='white',
            pos=(-0.35, 0),    # Centered vertically at 0
            bold=True,
            alignText='center'  # Center align the text
        )
